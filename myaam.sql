...
-- Records of t_admin
-- ----------------------------
INSERT INTO `t_admin` VALUES (1, '格格', '13333333333', '71937538', '河南省郑州市翻斗花园', 1, 'admin', '$2a$10$FpiNgEvmd8Yjcryup/pIP.S1AOpqneYmXeW4tCyzobVfhvycPZqXi', 'https://sz-1316545652.cos.ap-nanjing.myqcloud.com/1.jpg', NULL);
INSERT INTO `t_admin` VALUES (2, '张三', '18888888888', '41413109', '河南省洛阳市没那么回事小区', 1, 'taomeng', '$2a$10$oE39aG10kB/rFu2vQeCJTu/V/v4n6DRR0f8WyXRiAYvBpmadoOBE.', 'https://sz-1316545652.cos.ap-nanjing.myqcloud.com/2.jpg', NULL);
INSERT INTO `t_admin` VALUES (3, '李四', '15555555555', '50603155', '河南省马哈吨', 1, 'naqiao', '$2a$10$oE39aG10kB/rFu2vQeCJTu/V/v4n6DRR0f8WyXRiAYvBpmadoOBE.', 'https://sz-1316545652.cos.ap-nanjing.myqcloud.com/3.jpg', NULL);
INSERT INTO `t_admin` VALUES (4, '王五', '19288877731', '25546253', '河南省纽约市澳大利亚大松鼠', 1, 'leisu', '$2a$10$oE39aG10kB/rFu2vQeCJTu/V/v4n6DRR0f8WyXRiAYvBpmadoOBE.', 'https://sz-1316545652.cos.ap-nanjing.myqcloud.com/4.jpg', NULL);
INSERT INTO `t_admin` VALUES (5, '刘七', '13113113131', '27523842', '新疆羊肉串贩卖区', 1, 'hanli', '$2a$10$oE39aG10kB/rFu2vQeCJTu/V/v4n6DRR0f8WyXRiAYvBpmadoOBE.', 'https://sz-1316545652.cos.ap-nanjing.myqcloud.com/5.jpg', NULL);
...
INSERT INTO `t_admin_role` VALUES (105, 5, 2);
INSERT INTO `t_admin_role` VALUES (106, 5, 3);
INSERT INTO `t_admin_role` VALUES (152, 2, 3);
INSERT INTO `t_admin_role` VALUES (153, 2, 1);
INSERT INTO `t_admin_role` VALUES (154, 3, 3);
INSERT INTO `t_admin_role` VALUES (155, 3, 4);
...
-- ----------------------------
INSERT INTO `t_mail_log` VALUES ('6da01a6f-a875-475a-a60d-43a6defd1419', 204, 1, 'mail.routing.key', 'mail.exchange', 0, '2023-01-19 10:55:45', '2023-01-19 10:54:45', '2023-01-19 10:54:45');
...
INSERT INTO `t_menu` VALUES (2, '/', '/home', 'Home', '员工资料', 'fa fa-user-circle-o', NULL, 1, 1, 0);
...
INSERT INTO `t_menu` VALUES (5, '/', '/home', 'Home', '统计管理', 'fa fa-bar-chart', NULL, 1, 1, 0);
...
INSERT INTO `t_menu` VALUES (10, '/personnel/ec/**', '/per/ec', 'PerEc', '员工奖惩', NULL, NULL, 1, 3, 0);
INSERT INTO `t_menu` VALUES (11, '/personnel/train/**', '/per/train', 'PerTrain', '员工培训', NULL, NULL, 1, 3, 0);
INSERT INTO `t_menu` VALUES (12, '/personnel/salary/**', '/per/salary', 'PerSalary', '员工调薪', NULL, NULL, 1, 3, 0);
INSERT INTO `t_menu` VALUES (13, '/personnel/remove/**', '/per/mv', 'PerMv', '员工调动', NULL, NULL, 1, 3, 0);
...
INSERT INTO `t_menu` VALUES (16, '/salary/table/**', '/sal/table', 'SalTable', '工资表管理', NULL, NULL, 1, 4, 0);
INSERT INTO `t_menu` VALUES (17, '/salary/month/**', '/sal/month', 'SalMonth', '月末处理', NULL, NULL, 1, 4, 0);
INSERT INTO `t_menu` VALUES (18, '/salary/search/**', '/sal/search', 'SalSearch', '工资表查询', NULL, NULL, 1, 4, 0);
...
INSERT INTO `t_menu` VALUES (24, '/system/cfg/**', '/sys/cfg', 'SysCfg', '系统管理', NULL, NULL, 1, 6, 0);
INSERT INTO `t_menu` VALUES (25, '/system/log/**', '/sys/log', 'SysLog', '操作日志管理', NULL, NULL, 1, 6, 0);
INSERT INTO `t_menu` VALUES (26, '/system/admin/**', '/sys/admin', 'SysAdmin', '操作员管理', NULL, NULL, 1, 6, 1);
INSERT INTO `t_menu` VALUES (27, '/system/data/**', '/sys/data', 'SysData', '备份恢复数据库', NULL, NULL, 1, 6, 0);
INSERT INTO `t_menu` VALUES (28, '/system/init/**', '/sys/init', 'SysInit', '初始化数据库', NULL, NULL, 1, 6, 0);
...
INSERT INTO `t_menu_role` VALUES (356, 7, 4);
INSERT INTO `t_menu_role` VALUES (357, 8, 4);
INSERT INTO `t_menu_role` VALUES (358, 11, 4);
